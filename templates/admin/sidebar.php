...
function is_admin_active(string $path, string $current_uri): bool {
    if ($path === '/admin' || $path === '/admin/dashboard.php') {
        return $current_uri === '/admin' || $current_uri === '/admin/' || $current_uri === '/admin/index.php' || $current_uri === '/admin/dashboard.php';
    }
...
<aside class="admin-sidebar">
    <div class="admin-sidebar-header">
        <a href="/admin" class="admin-sidebar-brand">
            ...
            <div class="brand-text">
                <span class="brand-name">Instituto APS</span>
    ...
    <nav class="admin-nav">
        ...
        <div class="admin-nav-item">
            <a href="/admin" class="admin-nav-link <?= is_admin_active('/admin', $uri) ? 'active' : '' ?>">
        ...
        <div class="admin-nav-item">
            <a href="/admin/projetos" class="admin-nav-link <?= is_admin_active('/admin/projetos', $uri) ? 'active' : '' ?>">
        ...
        <div class="admin-nav-item">
            <a href="/admin/noticias" class="admin-nav-link <?= is_admin_active('/admin/noticias', $uri) ? 'active' : '' ?>">
        ...
        <div class="admin-nav-item">
            <a href="/admin/curriculos" class="admin-nav-link <?= is_admin_active('/admin/curriculos', $uri) ? 'active' : '' ?>">
        ...
        <div class="admin-nav-item">
            <a href="/admin/fornecedores" class="admin-nav-link <?= is_admin_active('/admin/fornecedores', $uri) ? 'active' : '' ?>">
        ...
        <div class="admin-nav-item">
            <a href="/admin/configuracoes" class="admin-nav-link <?= is_admin_active('/admin/configuracoes', $uri) ? 'active' : '' ?>">
        ...
        <div class="admin-nav-item mt-4">
            <a href="/admin/logout.php" class="admin-nav-link nav-logout">
